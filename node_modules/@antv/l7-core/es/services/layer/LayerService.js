...
var LayerService = (_dec = injectable(), _dec2 = inject(TYPES.IRendererService), _dec3 = inject(TYPES.IMapService), _dec4 = inject(TYPES.IDebugService), _dec(_class = (_class2 = /*#__PURE__*/function (_ref) {
  ...
  _createClass(LayerService, [{
              ...
              case 9:
                ...
                if (layer.masks.filter(function (m) {
                  ...
                  layer.masks.map( /*#__PURE__*/function () {
                    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(m) {
    ...
    value: function () {
      var _beforeRenderData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(layer) {
        var flag;
    ...
    key: "renderLayer",
    value: function () {
      var _renderLayer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(layer) {
        var _this5 = this;
