...
function geometry(params) {
    ...
    // 2. node edge views
    // @ts-ignore
    var _b = helper_1.transformToViewsData(options, chart.width, chart.height), nodes = _b.nodes, edges = _b.edges;
    // edge view
    ...
    geometries_1.edge({
        ...
        options: {
            ...
            rawFields: tslib_1.__spreadArrays(['source', 'target'], rawFields),
            edge: {
                color: color,
                style: edgeStyle,
                shape: 'arc',
...
function animation(params) {
    ...
    view_1.addViewAnimation(chart, animation, geometries);
    return params;
}
